...
public class SelectionSort {
    ...
    public static void selectionSortParaMortes(String[][] v) {
	...
	public static void selectionSortParaCasos(String[][] v) {
	...
	public static void selectionSortParaString(String[][] v) {
